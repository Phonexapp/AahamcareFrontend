...
const OldAgeHomeListView = () => {
    const [OldAgeHomeData, setOldAgeHomeData] = useState([]);
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", minHeight: "100vh", backgroundColor: "#f0f0f0", padding: "20px" }}>
            {OldAgeHomeData.map((value, index) => (
                <Box
                    ...
                    onClick={() => Navigate(`/OldAgeHomeDetail/${value._id}`)}
                >
...
export default OldAgeHomeListView;
