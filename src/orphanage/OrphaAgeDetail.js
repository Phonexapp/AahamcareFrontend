...
import OrphanAgeDetaillit from "../OrphnAgeDetailList/OrphanAgeDetaillt.js";
import OrphanAgeHomeAttendance from "../OrphnAgeDetailList/OrphanAgeHomeAttendance.js";
import OrphanAgeHomeRequirement from "../OrphnAgeDetailList/OrphanAgeHomeRequirement";
    ...
    return <>
        ...
        </Tabs>
        {
            OldAgeDtaillistBoolean ? (
                <OrphanAgeDetaillit Id={param.id} />
            ) : null
        }

        {
            OldHomeAttendanceBoolean ? (
                <OrphanAgeHomeAttendance Id={param.id} />
            ) : null
        }

        {
            OldHomeRequirementBoolen ? (
                <OrphanAgeHomeRequirement Id={param.id} />
            ) : null
        }
    </>
}
